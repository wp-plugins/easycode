ecAdmin = {
	...
	'changeStyleRadio':
	function(radioValue){
		var o1=document.getElementById('system_color'),o2=document.getElementById('inputcolor');
		if(radioValue===undefined){
			ros=document.getElementById('use_custom_color');
			if(ros.checked==true) radioValue=1;
		}
		if(radioValue){
